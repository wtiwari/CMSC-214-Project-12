...
create user 'bob'@'localhost' identified by 'tiger';
grant select, insert, update, delete, create, create view, drop,
 execute, references on javabook.* to 'bob'@'localhost';
...
commit;
/*EXPLAIN create table Person(firstName varchar(20), mi char(1), lastName varchar(20))*/
/*drop database javabook*/
